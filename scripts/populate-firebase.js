...
const PRODUCTS = [
    { id: '1', name: 'Paracetamol', brand: 'GENERIC', category: 'medicines', price: 25, originalPrice: 25, rating: 4.0, reviews: 245, deliveryTime: 12, description: 'Effective pain reliever and fever reducer. Pack of 10 tablets.', warranty: '1 Year', returnDays: 7, imageUrl: 'https://res.cloudinary.com/dhjzybacp/image/upload/v1776356502/paracetamol_oxdkym.jpg', stock: 100 },
    { id: '2', name: 'Saras Milk', brand: 'SARAS', category: 'grocery', price: 26, originalPrice: 27, rating: 4.9, reviews: 892, deliveryTime: 15, description: 'Fresh and pure milk, 1 liter. Rich in calcium and vitamins.', warranty: null, returnDays: 3, imageUrl: 'https://res.cloudinary.com/dhjzybacp/image/upload/v1776356502/sarash_milk_wghgl7.avif', stock: 150 },
    { id: '3', name: 'Hand Sanitizer Dettol', brand: 'DETTOL', category: 'beauty', price: 30, originalPrice: 30, rating: 4.5, reviews: 567, deliveryTime: 10, description: '99.9% germ protection. 500ml bottle.', warranty: null, returnDays: 14, imageUrl: 'https://res.cloudinary.com/dhjzybacp/image/upload/v1776356501/Hand_senitizer_aljpnf.jpg', stock: 200 },
    { id: '4', name: 'Bru Coffee', brand: 'BRU', category: 'grocery', price: 18.5, originalPrice: 22.0, rating: 4.7, reviews: 1203, deliveryTime: 18, description: 'Instant premium coffee powder. 100g pack.', warranty: null, returnDays: 7, imageUrl: 'https://res.cloudinary.com/dhjzybacp/image/upload/v1776356501/Bru_coffee_cqu6gi.jpg', stock: 180 },
    { id: '5', name: 'CMF Buds Pro 2', brand: 'NOTHING', category: 'electronics', price: 45.0, originalPrice: 59.0, rating: 4.6, reviews: 430, deliveryTime: 25, description: 'Wireless earbuds with active noise cancellation. 40-hour battery life.', warranty: '1 Year Warranty', returnDays: 14, imageUrl: 'https://res.cloudinary.com/dhjzybacp/image/upload/v1776356502/CMF_buds_pro_2_w9tfqx.jpg', stock: 50 },
    { id: '6', name: 'Dot & Key 10% Vitamin C+E', brand: 'DOT & KEY', category: 'beauty', price: 24.0, originalPrice: 28.0, rating: 4.4, reviews: 789, deliveryTime: 14, description: 'Brightening vitamin C serum. 30ml bottle.', warranty: null, returnDays: 30, imageUrl: 'https://res.cloudinary.com/dhjzybacp/image/upload/v1776356503/serum_bghsjz.webp', stock: 75 },
    { id: '7', name: 'Red Bull Energy Drink', brand: 'RED BULL', category: 'grocery', price: 50.0, originalPrice: 55.0, rating: 4.3, reviews: 456, deliveryTime: 12, description: '250ml energy drink. Gives you wings!', warranty: null, returnDays: 3, imageUrl: 'https://res.cloudinary.com/dhjzybacp/image/upload/v1776356502/red-bull_e86uhg.avif', stock: 120 },
