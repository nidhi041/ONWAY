...
const styles = StyleSheet.create({
  ...
  paymentGrid: { flexDirection: 'column', gap: 12, marginBottom: 10 },
  paymentCard: {
  ...
  paymentTitle: { fontSize: 15, fontWeight: '700', color: C.ink, marginBottom: 2 },
  paymentDescription: { fontSize: 12, color: C.inkMuted },
